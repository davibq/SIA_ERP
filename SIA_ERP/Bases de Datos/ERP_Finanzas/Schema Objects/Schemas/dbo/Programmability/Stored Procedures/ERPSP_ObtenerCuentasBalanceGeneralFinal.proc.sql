CREATE PROCEDURE [dbo].[ERPSP_ObtenerCuentasBalanceGeneralFinal]
...
AS
	...
	SELECT Cuen.Nombre NombreCuenta, SalXCuXMo.Saldo SaldoCuenta, Mon.Acronimo AcronimoMoneda, Mon.EsLocal
	...
	WHERE Cuen.Enabled = 1 AND Mon.EsSistema = 1 AND Cuen.Codigo LIKE @CodigoPadre+'%' AND SalXCuXMo.Saldo!=0
