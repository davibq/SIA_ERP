...
EXEC dbo.ERPSP_ActualizarCuenta 'Inventario Dotacion', '1-1-03-04', 4, 1, '1-1-03', 'Activo', '<MonedasCuenta><Moneda moneda="CRC"/><Moneda moneda="USD"/></MonedasCuenta>', '<Nombres><Nombre nombre="Inventario Dotacion" idioma="es"/></Nombres>'
...
EXEC dbo.ERPSP_ActualizarCuenta 'Impuesto Venta por pagar', '2-1-01-03', 4, 1, '2-1-01', 'Pasivo', '<MonedasCuenta><Moneda moneda="CRC"/><Moneda moneda="USD"/></MonedasCuenta>', '<Nombres><Nombre nombre="Impuesto Venta por pagar" idioma="es"/></Nombres>'
...
EXEC dbo.ERPSP_ActualizarCuenta 'Impuesto Venta', '6-2-03' , 3, 1, '6-2', 'Gastos', '<MonedasCuenta><Moneda moneda="CRC"/><Moneda moneda="USD"/></MonedasCuenta>', '<Nombres><Nombre nombre="Impuesto Venta" idioma="es"/></Nombres>'
...
EXEC dbo.ERPSP_InsertarPeriodoContable '2012/1/1', '2012/12/31', 2012 , '<Meses><Mes Nombre="Enero" FechaInicio="2012/1/1" FechaFin="2012/1/31" Estado="Abierto"/><Mes Nombre="Febrero" FechaInicio="2012/2/1" FechaFin="2012/2/28" Estado="Abierto"/><Mes Nombre="Marzo" FechaInicio="2012/3/1" FechaFin="2012/3/31" Estado="Abierto"/><Mes Nombre="Abril" FechaInicio="2012/4/1" FechaFin="2012/4/30" Estado="Abierto"/><Mes Nombre="Mayo" FechaInicio="2012/5/1" FechaFin="2012/5/31" Estado="Abierto"/><Mes Nombre="Junio" FechaInicio="2012/6/1" FechaFin="2012/6/30" Estado="Abierto"/><Mes Nombre="Julio" FechaInicio="2012/7/1" FechaFin="2012/7/31" Estado="Abierto"/><Mes Nombre="Agosto" FechaInicio="2012/8/1" FechaFin="2012/8/31" Estado="Abierto"/><Mes Nombre="Septiembre" FechaInicio="2012/9/1" FechaFin="2012/9/30" Estado="Abierto"/><Mes Nombre="Octubre" FechaInicio="2012/10/1" FechaFin="2012/10/31" Estado="Abierto"/><Mes Nombre="Noviembre" FechaInicio="2012/11/1" FechaFin="2012/11/30" Estado="Abierto"/><Mes Nombre="Diciembre" FechaInicio="2012/12/1" FechaFin="2012/12/31" Estado="Abierto"/></Meses>'
